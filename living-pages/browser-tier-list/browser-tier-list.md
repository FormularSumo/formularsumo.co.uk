...
browsers:
    A:
        ...
        Vivaldi:
            marketshare: 0.002
            pros: [
                "<a href='https://vivaldi.com/en/company/'>Owned by its employees</a>, who are in my experience lovely people (all the way up to the CEO). It does not accept external funding, does not chase rapid growth, and of all the browsers in this list has the most transparent and sustainable business mode.",
    ...
    B:
        Chrome: 
            ...
            pros: [
                ...
                "Google has the largest browser engineering team by quite a substantial margin, and does most of the work that goes into Chromium. As such they tend to have the fastest security and critical issue response teams"
            ]
            cons: [
    ...
    C:
        Opera:
            ...
            cons: [
                "Run by a Chinese billionaire and used as a vehicle for pushing their ad network, gaming business, news app, until recently Fintech microlending etc. History of launching browsers in response to current trends, and sometimes abandoning them after.", 
    ...
    D:
        ...
        Brave:
            ...
            cons: [
                ...
                "As part of this, blurs the lines between sponsorships and browser features, UI feels like an <a href='https://en.wikipedia.org/wiki/Brave_(web_browser)'>advert</a>",
