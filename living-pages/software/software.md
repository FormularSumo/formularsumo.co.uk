...
My biggest gripe is that searches can be [a bit slow vs other engines](https://social.vivaldi.net/@FormularSumo/117150427165158989). Occasionally results seem a little more limited as well, though on the whole they're pretty good. I did found Ecosia's initial AI overviews to be be somewhat heavy-handed, but they've since added an option to disable it entirely which is good. And generally they have been great at listening to feedback. They added set-up instructions for [Firefox Android](https://support.ecosia.org/article/653-installing-ecosia-on-your-mobile-device#Set-Ecosia-as-your-default-search-engine-on-Firefox-Android-JKq6N) and cleared up their mobile guide, and added Mastodon links to all of their subdomain footers after I got in touch with them :)
