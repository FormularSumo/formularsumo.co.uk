...
toc_tags: '{"tags":["h2"]}'
footnotes: [
    "From a zoomed out view, you can see that Apple Maps has full coverage of Western/Northern Europe up to Poland and Hungary, as well Greece, and of the US and Canada, plus Japan and Thailand. Upon zooming in further, there's a few other countries which appear to be complete but not visible when zoomed out, including New Zealand, Taiwan, and Israel. Other countries have partial coverage, eg of metro systems and/or regional lines, such as parts of Australia, Brazil and Mexico. Apparently Apple Maps have full China coverage but this isn't shown unless you're in China, the rest of the world only sees high-speed lines. Generally coverage is heavily biased towards wealthy countries where Apple devices sell well, meaning large parts of the world are excluded. It seems like there's no coverage of Africa, and very little of Asia and Latin America other than those mentioned above."
]
---
...
<img class="vertical" alt="Vertical screenshot of Apple Maps showing Europe and North Africa. Major rail lines are shown in blue, which has a high contrast with the lighter green background. Major cities are labelled with white dots. The coverage ends in Poland and Hungary, being blank for Russia, Romania, and all of Africa." src="informational/apple-maps-1.avif" loading="lazy">
