...
footnotes: [
    ...
    "A <a href='https://en.wikipedia.org/wiki/New_Routemaster'>standard London double decker bus</a> has a capactiy of 62 seated, or 80-87 with standing, while a <a href='https://en.wikipedia.org/wiki/Mercedes-Benz_Citaro'>typical single-decker bus</a> might have closer to 40 seated, or 130 with standing.",
    ...
    "Spain's high-speed train network is generally speaking great. It's the largest in Europe, goes direct (or almost direct) between lots of the biggest places, and is modern, comfortable, cheap, fast and overall a good experience. However, for some reason they've implemented airport-like security at their stations, which means arriving at least 15 minutes (recommended 30) earlier to pass through, and which can be quite stressful if you're running late. Additionally some of these stations like Madrid-Charmatin (the biggest one in the network) have very long walks to actually to the high-speed departues section, without any conveyors, and the train companies generally try to charge (although I'm not sure how enforced it is) for taking lots of luggage, bikes or pets. Taking the worst parts of air travel and artifically applying them to trains is not a good way to get people to switch over, and is not something typical found in Europe.",
    "Some places, such as Amsterdam, have special traffic light systems which are designed to let through public transport. This can be a timing thing such as the more obvious case of level-crossing, but nowadays it can also be done with sensors/GPS. When a bus for example is approaching, perhaps 30 seconds to a minute away, the lights will begin to change such that when the bus arrives it's already gone green. These systems are also used to prioritise pedestrians, so lights don't stay red for them if there's no cars approaching, meaning the default is to be green rather red for them. This is really important as humans are quite impatient and lights can strongly (and subconciously) affect how friendly and welcoming a pedestrian route is perceived to be. It's been shown that people are much happier when they can continue on their way without interruptions, even if the journey is actually longer (such as some airport baggage-collection designs).",
    "The London Underground Northern line for example is famous for its high noise levels. I've heard that long-exposure can lead to hearing loss, so this is certainly not the example to follow. Madrid's metro in my experience is much quiter and more generally nicer and better looked after, despite being far cheaper and having better coverage of the city and surrounding areas.",
    "Public APIs can be uesd by mapping/navigation applications such as Google Maps or OpenStreetMaps, for example to show transport routes on the map, with live updates and as part of suggested navigation options. It can also provide updates on current service (repairs, strikes), busyness and free seats, and even show the location of vehicles in real time. Of course most of this information can usually be found elsewhere, on the transport provider's site/app, printed on stations, etc, but it's often much easier for people to have it in one place, and to be able to do all this without having to switch to a new system (potentially for each different place they travel to). It's especially powerful when combined with walking and cycling navigation for multimodal trips.",
...
It's common knowledge that combustion engine cars are one of the most polluting forms of transport (and the transport sector itself is the [second most polluting](https://ourworldindata.org/emissions-by-sector)), heavily impacting global warming and the climate emergency, local levels of air pollution, and noise pollution. And according to the latest UK Gov statistics, their greenhouse emissions per kilometre are second only to domestic flights, an option so unsustainable that countries such as France are taking steps to ban them<sup><a id="n-2" href="#fn-2">2</a></sup>.
...
While most people are familiar with the high levels of pollution caused by cars, their impact on space usage and subsequent effects on city designs is often less well understood. I've already alluded to their poor carrying capacity but to put things into perspective <p class="caption">it's helpful to see a visualisation.
...
The above RAC foundation report states there there were over 27 million private cars in 2012, close to one for every other person, and the [Department for Transport estimates](https://www.gov.uk/government/statistics/national-travel-survey-2022/national-travel-survey-2022-household-car-availability-and-trends-in-car-trips) that 78% of households have at least one car, with 34% having two or more. With so many people owning cars, driving them around and parking them, it becomes inevitable that many places end up being designed for cars and incorportating large car parks, large stroads, and human-unfriendly designs.
...
<p class="caption">
<a href="https://turbli.com/blog/the-safest-transport-modes-ranked-by-statistics-from-10-years-of-data/"><img src="fatalities-distance.jpg" alt="Bar graph of fatalities per billion passenger miles of various modes of transport in the US between 2010 and 2019. From high to low: Motorcycle (212), Private plane (34), Light truck (9.3), Car (3.5), Commuter plane (2.8), Heavy truck (2.6), Ferryboat (0.89), Train (0.31), Bus (0.14), Commercial plane (0.002)"></a>
Fatality rates per distance travelled of different modes of transport, US, 2010-2019</p>

Looking at data from the US Bureau of Transportation Statics<sup><a id="n-5" href="#fn-5">5</a></sup> we can see that motorcycles, trucks and cars have the highest rate of occupant fatalities (private jets notwithstanding). But the true picture is worse than it looks because a significant number of the fatalities caused by these vehicles are not the vehicle ocupants or even other vehicles, but rather pedestrians and cyclists. In fact, walking and cycling are [statistically some of the least safe forms of transport](https://www.gov.uk/government/statistics/reported-road-casualties-great-britain-road-user-risk-2022/reported-road-casualties-great-britain-road-user-risk-2022-data), despite causing next to zero incidents themselves.

<p class="caption">
<img src="fatalities-time.jpg" alt="Bar graph of fatalities per billion passenger hours of various modes of transport in the US between 2010 and 2019. From high to low: Motorcycle (8171), Private plane (4719), Commuter plane (445), Light truck (296), Car (120), Heavy truck (86), Train (19), Ferryboat (7.7), Bus (3.0), Commercial plane (0.88)">
...
Surely the most iconic form of public transport is the bus. And buses do some have quite important features. Unlike many heavier forms of transport, they're very flexible and easy to run. To set-up up a bus route you just need to get a bus running, and place some bus stops (they can be as simple as a sign). This means they're able to go almost anywhere, and are able to quickly accomodate new developments and destinations into their routes. Buses are also typically very easy to get on and off as, at least with local ones, it's usually as simple as getting on<sup><a id="n-8" href="#fn-8">8</a></sup>, without any need to pass through a station and find a platform. This, alongside the fact that they usually have a lot of fairly close-together stops given they can quickly brake and accelerate, makes them generally better-suited to less mobile folk who aren't able to walk so far.
...
And investment in [walking, biking](https://www.ippr.org/articles/making-every-pound-count) and [public transport](https://www.newstatesman.com/spotlight/healthcare/public-health/2024/02/active-travel-ippr-report-walking-cycling-cars-roads-pollution-prevention) infrastructure are some of the best investments an authority can make, having a return of at least 2x that of car infrastructure, while often being much cheaper and easy to build. And these RoI comparisons don't even take into consideration many of the other knock-on effects that we have covered in this article.

On an individual level the average UK household currently spends 14% of its expenditure on transport, the vast majority of which is spent on cars. And the government spends substantial amounts of money on car infrastructure, due to the above reasons of car-first design, but also on simply building and reparing or replacing roads, bridges and tunnels, parking, road signs, speed cameras and reduction programs, and much more. And as we've seen, the costs of car infrastructure grows exponentially the more of it you build, and pushes people away from other much more sustainable and financial-sound modes of transport. 17% of local roads are estimated to be in poor condition, and somewhere between 4 and 7% of main roads are in need of repair right now. But most of these costs are fronted by the government and not paid for directly by road users, despite the fact that most are incurred by them. Why shouldn't it be the same for public transport?

<p class="caption">
<a href="https://dataportal.orr.gov.uk/statistics/finance/rail-industry-finance/"><iframe height="515px" width="100%" style="border:none;" src="https://app.powerbi.com/view?r=eyJrIjoiMGY4M2Q4MGUtNWE5Mi00YTZjLWIyNGEtNTMzNmFkNTliMTNiIiwidCI6IjIzMjM3OTk2LTdmM2EtNDM5NC04MGY1LTQ2MGNiYzA3NjEzYiJ9"></iframe></a>
Rail industry finance (UK), annual income and expenditure breakdown</p>

In a way, it already is. Public transport *is* subsidised by the government; they fund just under half of national rail costs, and a [similar proportion](https://commonslibrary.parliament.uk/research-briefings/cbp-9464/) of buses. But the amount which the government spends on all transport, including roads, is really quite small. It's currently at around [3.8% of the overall budget](https://ifs.org.uk/taxlab/taxlab-key-questions/what-does-government-spend-money), of which about 1.3% is spent on directly funding public transport after taking into account its current revenue. This is about as much as we spend on oversas aid, or 4x less than is spent on defense. Imagine if this figure was
...
Public transport = many many benefits, and lower cost per person
But car = big investment when made (when made necessary), sunk cost fallacy
Therefore, public transport needs to be competitively priced, and it needs to have the option of unlimited travel, at least for short-mid distance
This also allows it to turn into a social norm, where people are easy able to and willing to do it
Although it costs more upfront, it actually costs people less, and significantly increases financial productivity
Is it possible? How much the government currently pays - also subsidising roads. Luxembourg as an example. And Japan for general rail usage.
...
17% of local roads in poor condition, estimated 16.81b to repair
https://commonslibrary.parliament.uk/research-briefings/cbp-9975/


11.7 seconds per vehicle mile average delay. 21 in London. Over 24h time period. A/M roads.

Maintainance 2024 England, local authorities, red/amber: 4/27% A/M, 7/31 B/C, 17 U
Trunk needs futher investigation: 4% M, 7% A.

Cars and taxis: 404.4
Light commercial vehicles: 93.0
Heavy goods vehicles: 27.3
Motorcycles: 4.6
Buses and coaches: 3.1
Total 532.4
Billions of kilometres, Great Britain
https://assets.publishing.service.gov.uk/media/664b7546b7249a4c6e9d3825/tra0204-km-by-vehicle-and-road-type.ods

85% / 4% = 21.25
3.1km / 404.4km = 0.0007
...
https://www.gov.uk/government/news/leisure-travel-tops-charts-for-reasons-people-choose-rail



Japan:tickets for delays otherwise not a valid work/school excuse
...
Japan, million passenger kilometres, 2019

74% electrified

<!-- 
https://data-explorer.oecd.org/vis?fs[0]=Topic%2C1%7CTransport%23TRA%23%7CAnnual%20transport%20trends%23TRA_ATT%23&pg=0&fc=Topic&bp=true&snb=6&vw=tb&df[ds]=dsDisseminateFinalDMZ&df[id]=DSD_TRENDS%40DF_TRENDSPASS&df[ag]=OECD.ITF&df[vs]=1.0&dq=.A....RAIL.&lom=LASTNPERIODS&lo=5&to[TIME_PERIOD]=false -->

<p class="caption"><a href="https://ourworldindata.org/data-insights/rail-travel-is-more-prevalent-in-japan-than-in-western-europe-and-much-more-than-in-the-united-states"><img src="rail-road-countries.avif" alt="."></a></p>

## When private road vehicles do make sense

Many disabilities and those with poor mobility (though often having to be driven by others) - previous reference to scooters, taxis
Off-road and remote locations or times (especially taxis, eg middle of the night), extreme whether?
...
Batteries weight too much. First commerical hydrogen-powered planes - small 10-20 seater propellor-crafst - are expected to be approved next year. Estimated 10 years before we have the technologoy for large commerical jets. Maybe another 10-15 before they're in common use? And green hydrogren production is still quite rare at the moment. Long-term it could work out, but short-mid term we need to avoid flying as much as we can for environmental reasons.
...
In practise most riders (in my experience) are very obnoxious - incredibly noise, lots of fumes, overtaking/otherwise driving illegally, generally endangering and making a place worse to be in. Too fast vs bikes? And dangerous.

## Resources

Strong Towns, Campaign for Better Transport
Walkable Cities, Not Just Bikes