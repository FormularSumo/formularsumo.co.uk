...
El [código fuente](https://github.com/FormularSumo/formularsumo.co.uk) se aloja en GitHub, donde los commits se construyen y se desplegan de una forma automáatica a [Cloudflare Pages](https://www.cloudflare.com/es-es/developer-platform/products/pages/). El dominio de internet se maneja por [Porkbun](https://porkbun.com/).
