...
foto: báltico.webp
foto_texto: Verde = el lituano, amarillo = el letón. El prusiano y el curonio son lenguas bálticas extintas.
foto_alt: Distribución de idiomas bálticos. El lituano se habla solo en Lituania, el letón solo en Letonia. El curonio se hablaba en la parte occidental de los dos, y el prusiano antiguo en la parte noreste de Polonia y Kaliningrado.
foto_enlace: https://es.wikipedia.org/wiki/Lenguas_b%C3%A1lticas#/media/Archivo:Baltic_languages.png
---
