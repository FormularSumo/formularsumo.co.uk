<?php
include 'article_details/pronombres.php';
...
$text = <<<EOD
    ...
    forma del cuerpo etc. Pero dejándolos de lado, no veo que el ser macho
    signifique que debas pensar en ti mismo de una manera diferente de ser hembra.
    No creo en lo más mínimo que las diferencias de los cuerpos sean suficientes
    para justificar un pronombre distinto. Puesto que el pronombre que usas
    realmente puede cambiar la idea preconcebida que se tiene de ti - a menudo de
    formas que no quieres.
    </p>
    <p>
    ...
    es tan común que se use el pronombre de su sexo asignado que require bastante
    esfuerzo el no hacerlo. Y visto así, no hay una solución “perfecta” por el
